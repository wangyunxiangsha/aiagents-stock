...
from stockapp.monitoring.notification_service import notification_service  # 复用主程序的通知服务
from stockapp.common.config_manager import config_manager  # 复用主程序的配置管理器
